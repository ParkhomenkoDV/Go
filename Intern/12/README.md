...
- Код выполнится нормально ~~Неправильно. Мы не можем записывать в неинициализированную `map`.~~
- Будет паника ~~Верно!~~
___
...
- Это объявление `map` с элементами типа `string` и ключами типа `int` ~~Неправильно. Тип ключей указывается в квадратных скобках, а тип элемента — за ними.~~
- Это объявление `map` с элементами типа `string` и ключами типа `string` ~~Неправильно. Тип ключей указывается в квадратных скобках, а тип элемента — за ними.~~
- Это объявление `map` с элементами типа `int` и ключами типа `string` ~~Верно! Тип ключей указывается в квадратных скобках, а тип элемента — за ними.~~
___
...
1. Заказ выдан слайсом `[]string{"хлеб", "буженина", "сыр", "огурцы"}`. Посчитайте стоимость заказа.
