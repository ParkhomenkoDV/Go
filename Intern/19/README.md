...
___
Почему следует использовать go.mod для установки зависимостей?

- Это даёт возможность удобно хранить список зависимостей в одном файле ~~Да! Установка всех зависимостей из файла также очень удобна.~~
- Этот способ обеспечивает воспроизводимость запусков ~~Правильно, это происходит за счёт хранения контрольных сумм модулей.~~
- Потому что `go get` скоро перестанет поддерживаться ~~Нет, одна из особенностей Go — сохранение обратной совместимости.~~
___
Отметьте верные утверждения.

- В Go используется семантическое версионирование. ~~Да! Например, у пакета с версией `v1.2.3` есть мажорная версия 1, минорная 2 и патч-версия 3.~~
- Мажорная версия меняется в случае добавления новой функциональности.
- Минорная версия меняется в случае добавления новой функциональности. ~~Да, в случае добавления новой функциональности меняется минорная версия.~~
___
