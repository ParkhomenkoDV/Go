...
В пройденной теме вы научились определять типы ошибок, упаковывать и распаковывать их. Теперь вы умеете использовать функции пакета `errors` для обработки специфических ошибок в проектах на Go.

![](./assets/images/evolution_map_10.png)

# Заключение

Вы завершили третий спринт — поздравляем и гордимся вами!

![](./assets/images/Part1-only-sprint3.png)

Чтобы вы не перегрелись от объёма информации, просим вас выдохнуть, сделать паузу и, по традиции, ответить на несколько вопросов. Вам они помогут осознать опыт пройденного спринта, а нам — сделать курс лучше.